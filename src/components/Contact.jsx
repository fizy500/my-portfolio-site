...
export default function Contact() {
  const [state, handleSubmit] = useForm("mknljkne");
  ...
  return (
    <section className='bg-gray-900 flex flex-col items-center py-8 h-fit '>
      <div className='border border-dotted border-purple-400 rounded-sm w-full lg:w-[90%] py-8 px-4 lg:px-8 my-40'>
        <div className='bg-white rounded-sm  shadow-2xl  h-[70%] grid grid-cols-1 lg:grid-cols-2 py-6 gap-3'>
          <form
            action=''
            ...
            <div className='flex flex-col items-end justify-center space-y-20'>
              <div className='text-center space-y-2'>
                ...
                <div className='flex mr-4'>
                  <i className='text text-gray-400'>otuekongarthur@gmail.com</i>
                  <div
