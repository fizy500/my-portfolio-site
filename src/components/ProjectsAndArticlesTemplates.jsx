    ...
    <div className='flex justify-center items-start lg:space-x-14'>
      <div className='w-1/2 flex flex-col'>
        <div className='relative flex '>
          <img
            src='https://api.apify.com/v2/key-value-stores/ytaY5cgQFGhoMcgnN/records/main--phenomenal-kringle-305157.netlify.app-scroll_lossy-comp'
            alt='website gif'
            width=''
        ...
        <div className='flex content-center py-3'>
          <div>
            <a href='https://github.com/fizy500/shortly'>
              {" "}
              <svg
          ...
          <div>
            <a href='https://main--phenomenal-kringle-305157.netlify.app/'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 512 512'
                width='50'
