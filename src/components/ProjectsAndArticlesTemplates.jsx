  ...
  return (
    <div>
      {logos.map((logo) => {
        return (
          <div
            className='rounded-sm flex flex-col space-x-4 lg:flex-row items-center h-fit border border-dotted border-purple-400 mb-4 py-5 px-2 lg:px-6 '
            key={logo.id}
          >
...
export function ProjectsTemplate() {
  return (
    <div className='flex justify-center items-start lg:space-x-14'>
      ...
      <div className='w-1/2'>
        <h2 className="text-xs lg:text-xl text-purple-300 font-medium">Hospital management system</h2>
